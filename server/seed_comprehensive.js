...
async function seedDB() {
  try {
    ...
    const usersToCreate = [
      ...
      { username: 'mc_official', email: 'corp@nammaoorfix.gov.in', password: 'Password123', name: 'Municipal Corp Commissioner', role: 'official', department: 'Municipal Corporation', isVerified: true },
